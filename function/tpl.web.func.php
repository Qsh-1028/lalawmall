...
function wxapp_urls($type = "wmall")
{
    ...
    if ($type == "wmall") {
        ...
        if (check_plugin_perm('spread')) {
            $data["other"]["spread"] = array("title" => $_W["_plugins"]["spread"]["title"], "items" => array(array("title" => "推广中心", "url" => "plugin/pages/spread/index")));
        }
        if (check_plugin_perm('deliveryCard')) {
            $data["other"]["deliveryCard"] = array("title" => $_W["_plugins"]["deliveryCard"]["title"], "items" => array(array("title" => "配送会员卡特权说明", "url" => "package/pages/deliveryCard/power")));
        }
        ...
        if (check_plugin_perm('kefu')) {
            $data["other"]["kefu"] = array("title" => $_W["_plugins"]["kefu"]["title"], "items" => array(array("title" => "消息中心", "url" => "plugin/pages/kefu/index")));
        }
        $data["operation"] = array("scanCode" => array("title" => "扫码", "items" => array(array("title" => "扫码", "url" => "wx:scanCode"))), "refresh" => array("title" => "刷新", "items" => array(array("title" => "刷新", "url" => "refresh"))));
        $data["store"] = array(array("title" => "商户", "items" => array(array("title" => "门店详情", "url" => "pages/store/home?sid=" . $_GPC["__sid"]), array("title" => "点外卖", "url" => "pages/store/goods?sid=" . $_GPC["__sid"]), array("title" => "预定", "url" => "tangshi/pages/reserve/index?sid=" . $_GPC["__sid"]), array("title" => "当面付", "url" => "pages/store/paybill?sid=" . $_GPC["__sid"]), array("title" => "排号", "url" => "tangshi/pages/assign/assign?sid=" . $_GPC["__sid"]))));
        if (check_plugin_perm('kabao')) {
            $data["other"]["kabao"] = array("title" => $_W["_plugins"]["kabao"]["title"], "items" => array(array("title" => "门店会员卡首页", "url" => "plugin/pages/kabao/index")));
            $data["store"][0]["items"][] = array("title" => "门店会员卡", "url" => "plugin/pages/kabao/detail?sid=" . $_GPC["__sid"]);
        }
    } else {
        if ($type == "deliveryer") {
            ...
            if (check_plugin_perm('errander')) {
                $data["plugin"]["errander"] = array("title" => $_W["_plugins"]["errander"]["title"], "items" => array(array("title" => "跑腿订单", "url" => "pages/paotui/index"), array("title" => "跑腿统计", "url" => "pages/statcenter/errander")));
            }
            if (check_plugin_perm('kefu')) {
                $data["plugin"]["kefu"] = array("title" => $_W["_plugins"]["kefu"]["title"], "items" => array(array("title" => "消息中心", "url" => "pages/kefu/index")));
            }
            ...
            if ($type == "manager") {
                ...
                if (check_plugin_perm('gohome')) {
                    $data["plugin"]["gohome"] = array("title" => $_W["_plugins"]["gohome"]["title"], "items" => array(array("title" => "生活圈首页", "url" => "pages/gohome/index"), array("title" => "砍价列表", "url" => "pages/gohome/kanjia/goods/list"), array("title" => "拼团列表", "url" => "pages/gohome/pintuan/goods/list"), array("title" => "抢购列表", "url" => "pages/gohome/seckill/goods/list"), array("title" => "订单列表", "url" => "pages/gohome/order/index")));
                }
                if (check_plugin_perm('kefu')) {
                    $data["plugin"]["kefu"] = array("title" => $_W["_plugins"]["kefu"]["title"], "items" => array(array("title" => "消息中心", "url" => "pages/kefu/index")));
                }
                ...
                if ($type == "plateform") {
                    ...
                    if (check_plugin_perm('errander')) {
                        $data["plugin"]["errander"] = array("title" => $_W["_plugins"]["errander"]["title"], "items" => array(array("title" => "跑腿管理", "url" => "pages/plugin/paotui/index"), array("title" => "跑腿订单", "url" => "pages/plugin/paotui/list"), array("title" => "跑腿设置", "url" => "pages/plugin/paotui/config")));
                    }
                    if (check_plugin_perm('agent')) {
                        $data["plugin"]["agent"] = array("title" => $_W["_plugins"]["agent"]["title"], "items" => array(array("title" => "区域代理管理", "url" => "pages/plugin/agent/index"), array("title" => "代理列表", "url" => "pages/plugin/agent/agent"), array("title" => "提现记录", "url" => "pages/plugin/agent/getcash"), array("title" => "账户明细", "url" => "pages/plugin/agent/current")));
                    }
                    if (check_plugin_perm('creditshop')) {
                        $data["plugin"]["creditshop"] = array("title" => $_W["_plugins"]["creditshop"]["title"], "items" => array(array("title" => "兑换列表", "url" => "pages/plugin/creditshop/order")));
                    }
                    if (check_plugin_perm('deliveryCard')) {
                        $data["plugin"]["deliveryCard"] = array("title" => $_W["_plugins"]["deliveryCard"]["title"], "items" => array(array("title" => "购买记录", "url" => "pages/plugin/deliveryCard/order")));
                    }
                    if (check_plugin_perm('mealRedpacket')) {
                        $data["plugin"]["mealRedpacket"] = array("title" => $_W["_plugins"]["mealRedpacket"]["title"], "items" => array(array("title" => "购买记录", "url" => "pages/plugin/mealRedpacket/order")));
                    }
                    if (check_plugin_perm('wheel')) {
                        $data["plugin"]["wheel"] = array("title" => $_W["_plugins"]["wheel"]["title"], "items" => array(array("title" => "参与记录", "url" => "pages/plugin/wheel/record")));
                    }
                    if (check_plugin_perm('advertise')) {
                        $data["plugin"]["advertise"] = array("title" => $_W["_plugins"]["advertise"]["title"], "items" => array(array("title" => "购买记录", "url" => "pages/plugin/advertise/order")));
                    }
                    if (check_plugin_perm('kefu')) {
                        $data["plugin"]["kefu"] = array("title" => $_W["_plugins"]["kefu"]["title"], "items" => array(array("title" => "消息中心", "url" => "pages/plugin/kefu/index")));
                    }
