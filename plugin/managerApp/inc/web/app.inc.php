...
$downurls = array(
	'manager' => array('ios' => MODULE_URL . ('resource/apps/' . $_W['uniacid'] . '/ios/manager.apk'), 'android' => MODULE_URL . ('resource/apps/' . $_W['uniacid'] . '/android/manager.apk'), 'apk' => MODULE_ROOT . ('/resource/apps/' . $_W['uniacid'] . '/android/manager.apk'))
	);
