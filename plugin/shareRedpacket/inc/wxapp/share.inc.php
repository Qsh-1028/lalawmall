...
if( $op == "invite" ) 
{
    ...
    $result = array( "redPacket" => $redPacket, "member" => $member, "mall_title" => $_W["we7_wmall"]["config"]["mall"]["title"], "days_format" => $days_format, "captcha" => iaurl("system/common/captcha", array( "state" => "we7sid-" . $_W["session_id"], "t" => TIMESTAMP ), true) );
