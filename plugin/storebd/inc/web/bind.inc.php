...
if ($op == "index") {
    ...
    if ($op == "post") {
        ...
        if ($_W["ispost"]) {
            ...
            pdo_update('tiny_wmall_store', array('storebd_id' => $storebd_id), array("uniacid" => $_W["uniacid"], "id" => $sid));
        ...
        if ($op == "del") {
            ...
            pdo_update('tiny_wmall_store', array('storebd_id' => 0), array('uniacid' => $_W["uniacid"], "storebd_id" => $id));
