...
if ($op == 'index') {
	...
	$goodsinfo = pdo_fetchall('SELECT * FROM ' . tablename('tiny_wmall_cloudgoods_goods') . ($condition . ' order by displayorder desc,id DESC LIMIT ') . ($pindex - 1) * $psize . ',' . $psize, $params);
