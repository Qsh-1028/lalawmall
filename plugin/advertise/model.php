...
function advertise_clerk_notice($idOrTrade, $type = "pay", $extra = array())
{
    ...
    $params_send = array("title" => $title, "ordersn" => $trade["order_sn"], "final_fee" => $trade["final_fee"], "pay_type_cn" => advertise_get_pay_type_cn($trade), "delivery_title" => "******", "status_cn" => $status_cn, "remark" => $remark);
