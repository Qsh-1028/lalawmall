...
if ($op == "index") {
    ...
    $result = array("config" => $config_mall, "config_wxapp" => $_config_wxapp, "diy" => $page, "cart_sum" => $page["is_show_cart"] == 1 ? get_member_cartnum() : 0, "default_location" => $default_location, "userAgreement" => get_config_text("member:agreement"));
