    ...
    if ($_W["ispost"]) {
        ...
        if ($fee_takeout["type"] == 2) {
            ...
            if ($fee_takeout["type"] == 3) {
                $fee_takeout["level1"] = array("fee_start" => floatval($takeout_GPC["level1"]["fee_start"]), "fee" => floatval($takeout_GPC["level1"]["fee"]));
                ...
                $fee_takeout["level2"] = array("fee_start" => floatval($takeout_GPC["level2"]["fee_start"]), "fee" => floatval($takeout_GPC["level2"]["fee"]));
        ...
        if ($fee_selfDelivery["type"] == 2) {
            ...
            if ($fee_selfDelivery["type"] == 3) {
                $fee_selfDelivery["level1"] = array("fee_start" => floatval($selfDelivery_GPC["level1"]["fee_start"]), "fee" => floatval($selfDelivery_GPC["level1"]["fee"]));
                ...
                $fee_selfDelivery["level2"] = array("fee_start" => floatval($selfDelivery_GPC["level2"]["fee_start"]), "fee" => floatval($selfDelivery_GPC["level2"]["fee"]));
        ...
        if ($fee_instore["type"] == 2) {
            ...
            if ($fee_instore["type"] == 3) {
                $fee_instore["level1"] = array("fee_start" => floatval($instore_GPC["level1"]["fee_start"]), "fee" => floatval($instore_GPC["level1"]["fee"]));
                ...
                $fee_instore["level2"] = array("fee_start" => floatval($instore_GPC["level2"]["fee_start"]), "fee" => floatval($instore_GPC["level2"]["fee"]));
        ...
        if ($fee_paybill["type"] == 2) {
            ...
            if ($fee_paybill["type"] == 3) {
                $fee_paybill["level1"] = array("fee_start" => floatval($paybill_GPC["level1"]["fee_start"]), "fee" => floatval($paybill_GPC["level1"]["fee"]));
                ...
                $fee_paybill["level2"] = array("fee_start" => floatval($paybill_GPC["level2"]["fee_start"]), "fee" => floatval($paybill_GPC["level2"]["fee"]));
        ...
        $data = array("uniacid" => $_W["uniacid"], "agentid" => $_W["agentid"], "sid" => $sid, "fee_takeout" => iserializer($fee_takeout), "fee_selfDelivery" => iserializer($fee_selfDelivery), "fee_instore" => iserializer($fee_instore), "fee_paybill" => iserializer($fee_paybill), "fee_goods" => iserializer($fee_goods), "fee_gohome" => iserializer($gohome));
        ...
        if (!empty($_GPC["choice"])) {
            foreach ($_GPC["choice"]["name"] as $key => $value) {
                ...
                $member_choice[] = array("name" => $name, "desc" => $desc, "fee" => $fee, "status" => $status);
            }
