...
$downurls = array(
	'plateformApp' => array('android' => MODULE_URL . ('resource/apps/' . $_W['uniacid'] . '/android/plateform_1.0.apk'), 'apk' => MODULE_ROOT . ('/resource/apps/' . $_W['uniacid'] . '/android/plateform_1.0.apk'))
	);
