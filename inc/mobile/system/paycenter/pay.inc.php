...
$routers = array(
	'takeout'            => array('title' => $store['title'] . '-' . $record['order_sn'], 'url_pay' => imurl('system/paycenter/pay', array('id' => $order['id'], 'order_type' => 'takeout', 'type' => 1), true), 'url_detail' => imurl('wmall/order/index/detail', array('id' => $order['id']), true)),
	'errander'           => array('title' => '配送会员卡-' . $record['order_sn'], 'url_pay' => imurl('system/paycenter/pay', array('id' => $order['id'], 'order_type' => 'errander', 'type' => 1), true), 'url_detail' => imurl('errander/order/detail', array('id' => $order['id']), true)),
	'deliveryCard'       => array('title' => '配送会员卡-' . $record['order_sn'], 'url_pay' => imurl('deliveryCard/apply/index', array(), true), 'url_detail' => imurl('member/mine', array(), true)),
	'recharge'           => array('title' => '账户充值-' . $record['order_sn'], 'url_pay' => imurl('system/paycenter/pay', array('id' => $order['id'], 'order_type' => 'recharge', 'type' => 1), true), 'url_detail' => imurl('member/mine', array(), true)),
	'freelunch'          => array('title' => '霸王餐-' . $record['order_sn'], 'url_pay' => imurl('system/paycenter/pay', array('id' => $order['id'], 'order_type' => 'recharge', 'type' => 1), true), 'url_detail' => imurl('freeLunch/freeLunch/partake_success', array(), true)),
	'peerpay'            => array('title' => '帮人代付-' . $record['order_sn'], 'url_pay' => imurl('system/paycenter/pay', array('id' => $order['id'], 'order_type' => 'peerpay', 'type' => 1), true), 'url_detail' => imurl('system/paycenter/peerpay/paylist', array('id' => $paylist['pid']), true)),
	'paybill'            => array('title' => '买单-' . $record['order_sn'], 'url_pay' => imurl('system/paycenter/pay', array('id' => $order['id'], 'order_type' => 'paybill', 'type' => 1), true), 'url_detail' => imurl('member/mine', array(), true)),
	'mealRedpacket_plus' => array('title' => '套餐红包Plus-' . $record['order_sn'], 'url_pay' => imurl('system/paycenter/pay', array('id' => $order['id'], 'order_type' => 'mealRedpacket_plus', 'type' => 1), true), 'url_detail' => imurl('mealRedpacket/plus/plusOrder', array(), true))
	);
...
if (is_h5app()) {
	...
	$payinfo = array(
		'type'           => $type_pay,
		'item'           => array(
			array('title' => $title, 'cover' => '', 'num' => 1, 'gold_cost' => 0, 'cash_cost' => $_W['member']['uid'] == '112813212' ? 0.01 : $log['card_fee'])
			),
		'address'        => array('name' => $order['username'], 'mobile' => $order['mobile'], 'address' => $order['address']),
		'send_type'      => 0,
		'allow_pay_type' => 14,
