...
$urls = array(
	'coupon'   => array('title' => '我的代金券', 'url' => imurl('wmall/member/coupon'), 'css' => '', 'icon' => 'mypage_token.png'),
	'address'  => array('title' => '我的地址', 'url' => imurl('wmall/member/address'), 'css' => '', 'icon' => 'mypage_location.png'),
	'favorite' => array('title' => '我的收藏', 'url' => imurl('wmall/member/favorite'), 'css' => '', 'icon' => 'mypage_star.png'),
	'comment'  => array('title' => '我的评价', 'url' => imurl('wmall/member/comment'), 'css' => '', 'icon' => 'mypage_comment.png'),
	'recharge' => array('title' => '余额充值', 'url' => imurl('wmall/member/recharge'), 'css' => '', 'icon' => 'mypage_credit.png'),
	'help'     => array('title' => '常见问题', 'url' => imurl('wmall/home/help'), 'css' => '', 'icon' => 'mypage_problem.png')
	);
