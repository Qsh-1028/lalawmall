...
$params = array("tid" => $log["tid"], "fee" => $log["card_fee"], "user" => $log["openid"], "title" => urldecode($params["title"]), "uniontid" => $log["uniontid"], "global_fee" => round($log["card_fee"] * $_W["dollarrate"], 2));
