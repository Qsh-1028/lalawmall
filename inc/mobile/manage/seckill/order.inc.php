...
if ($ta == 'list') {
	...
	$order_status = array(
		1 => array('css' => 'label label-default', 'text' => '待核销', 'color' => ''),
		2 => array('css' => 'label label-success', 'text' => '已核销', 'color' => 'color-success'),
		3 => array('css' => 'label label-danger', 'text' => '已取消', 'color' => 'color-danger')
		);
