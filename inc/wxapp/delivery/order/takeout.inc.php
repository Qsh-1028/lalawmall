...
if ($ta == "list") {
    ...
    $result = array("orders" => $orders, "max_dispatching" => $config_takeout["order"]["max_dispatching"], "can_collect_order" => $can_collect_order, "deliveryer" => $_W["deliveryer"], "config" => array("auto_refresh" => $config_takeout["order"]["auto_refresh"]), "userAgreement" => get_config_text("deliveryer:agreement"));
