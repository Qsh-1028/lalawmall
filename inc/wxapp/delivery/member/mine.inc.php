...
if ($ta == "index") {
    ...
    $result = array("deliveryer" => $_W["deliveryer"], "stat" => $stat, "takeout_rank_status" => $config_delivery["extra"]["takeout_rank_status"], "errander_rank_status" => $config_delivery["extra"]["errander_rank_status"], "config" => array("development_delivery_location" => $_W["we7_wmall"]["global"]["development_delivery_location"]), "kefu" => $kefu);
