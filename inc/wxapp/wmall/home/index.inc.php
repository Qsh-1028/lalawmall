...
if ($ta == "index") {
    ...
    if (is_ios() && (is_h5app() || is_glala()) && !empty($config_app_customer) && empty($config_app_customer["iosstatus"]) && !empty($config_app_customer["iosurl"])) {
    ...
    $result["guide"] = $guide;
    $result["userAgreement"] = get_config_text("member:agreement");
