...
if ($ta == "post") {
    ...
    $data = array("uniacid" => $_W["uniacid"], "agentid" => $store["agentid"], "acid" => $_W["acid"], "sid" => $sid, "uid" => $_W["member"]["uid"], "openid" => $_W["openid"], "title" => $title, "note" => trim($_GPC["note"]), "mobile" => trim($_GPC["mobile"]), "addtime" => TIMESTAMP);
