...
mload()->model('plugin');
pload()->model('kefu');
$_W["kefu"]["user"] = $kefu = array("role" => "kefu", "kefu_id" => $_W["plateformer"]["uid"], "token" => $_W["plateformer"]["token"], "nickname" => "平台客服", "avatar" => "https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTKTpvfS1sTVsx0EZQzVGWdm7MSXkRGoVWtibHByLjeV3WSpNo3NDvJ9Yrg4uUqvlELSciamLibKpJJRg/132");
