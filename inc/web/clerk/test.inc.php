...
foreach ($wxcsShop as $value) {
	...
	$business_hours = array(
		array('business_start_hours' => $value['time'], 'business_end_hours' => $value['time4'])
		);
	...
	'business' => array('thumb' => trim($yyzz[0])),
	'more1'    => array('thumb' => trim($yyzz[1])),
	'more2'    => array('thumb' => trim($yyzz[2]))
	)), 'sailed' => intval($value['score']), 'business_hours' => iserializer($business_hours));
