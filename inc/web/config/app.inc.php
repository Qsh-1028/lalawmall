...
$downurls = array(
	'deliveryer' => array('ios' => MODULE_URL . ('resource/apps/' . $_W['uniacid'] . '/ios/deliveryman_1.0.apk'), 'android' => MODULE_URL . ('resource/apps/' . $_W['uniacid'] . '/android/deliveryman_1.0.apk')),
	'manager'    => array('ios' => MODULE_URL . ('resource/apps/' . $_W['uniacid'] . '/ios/manager.apk'), 'android' => MODULE_URL . ('resource/apps/' . $_W['uniacid'] . '/android/manager.apk')),
...
if ($op == 'deliveryer') {
	...
	if ($_W['ispost']) {
		$data = array(
			...
			'version'               => array('ios' => trim($_GPC['deliveryer']['version']['ios']), 'android' => 1),
			'ios_download_link'     => trim($_GPC['deliveryer']['ios_download_link']),
			'android_download_link' => MODULE_URL . ('resource/apps/' . $_W['uniacid'] . '/android/deliveryman_1.0.apk')
			);
...
if ($op == 'manager') {
	...
	if ($_W['ispost']) {
		...
		$data = array(
			...
			'version'               => array('ios' => trim($_GPC['manager']['version']['ios']), 'android' => 1),
