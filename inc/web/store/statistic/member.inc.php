...
if ($ta == "newAndOld") {
    ...
    if ($ta == "keep") {
        ...
        $conditionAndParams = array("active" => array("condition" => " where uniacid = :uniacid and sid = :sid and success_last_time >= :starttime and success_last_time < :endtime ", "params" => array(":uniacid" => $_W["uniacid"], ":sid" => $sid, ":starttime" => $time30, ":endtime" => TIMESTAMP)), "silence" => array("condition" => " where uniacid = :uniacid and sid = :sid and success_last_time >= :starttime and success_last_time < :endtime ", "params" => array(":uniacid" => $_W["uniacid"], ":sid" => $sid, ":starttime" => $time60, ":endtime" => $time30)), "runoff" => array("condition" => " where uniacid = :uniacid and sid = :sid and success_last_time >= :starttime and success_last_time < :endtime ", "params" => array(":uniacid" => $_W["uniacid"], ":sid" => $sid, ":starttime" => $time90, ":endtime" => $time60)), "giveup" => array("condition" => " where uniacid = :uniacid and sid = :sid and success_last_time > :starttime and success_last_time < :endtime ", "params" => array(":uniacid" => $_W["uniacid"], ":sid" => $sid, ":starttime" => 0, ":endtime" => $time90)));
        $total = 0;
