...
function get_manager_menu()
{
	...
	if (empty($menu)) {
		$menu = array(
			...
			'css'    => array('iconColor' => '#666', 'iconColorActive' => '#33aafc', 'textColor' => '#666', 'textColorActive' => '#33aafc'),
			'data'   => array(
				'M0123456789101' => array('link' => '/pages/order/index', 'icon' => 'icon-order', 'text' => '外卖'),
				'M0123456789102' => array('link' => '/pages/order/tangshi/index', 'icon' => 'icon-shop', 'text' => '店内'),
				'M0123456789103' => array('link' => '/pages/shop/home', 'icon' => 'icon-apps', 'text' => '运营'),
				'M0123456789104' => array('link' => '/pages/shop/setting', 'icon' => 'icon-settings', 'text' => '设置')
				)
			);
	}
	else {
