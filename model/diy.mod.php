...
function get_wxapp_diy($pageOrid, $mobile = false, $extra = array()) {
	...
	$page['parts'] = array();
	$page['is_has_location'] = $page['is_has_allstore'] = $page['is_show_cart'] = $page['is_show_redpacket'] = $page['is_show_service'] = $page['is_has_svip'] = $page['is_has_goodsTab'] = $page['is_has_storesTab'] = $page['cid'] = 0;
	$page['danmu'] = array();
	$page['is_show_kefu'] = 0;
	...
	if(empty($page['data']['page']['title']) || strexists($page['data']['page']['title'], '有鱼外卖')) {
				...
				foreach($stores as &$row) {
					...
					if(!empty($hot_goods)) {
						foreach($hot_goods as &$goods) {
							...
							$hot_childid = rand(1000000000, 9999999999);
